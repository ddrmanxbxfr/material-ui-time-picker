...
var styles = function styles(theme) {
  return {
    ...
    outerDotOdd: {
      background: (0, _colorManipulator.getContrastRatio)(theme.palette.primary[500], theme.palette.common.fullBlack) < 7 ? theme.palette.common.fullWhite : theme.palette.common.fullBlack,
      width: 4,
      height: 4,
      borderWidth: 14
    }
