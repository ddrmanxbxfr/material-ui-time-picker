...
var styles = function styles(theme) {
  return {
    ...
    number: {
      ...
      userSelect: 'none',
      '&.selected': {
        color: (0, _colorManipulator.getContrastRatio)(theme.palette.main, theme.palette.common.fullBlack) < 7 ? theme.palette.common.fullWhite : theme.palette.common.fullBlack
      }
    },
    smallNumber: {
      fontSize: '12px',
    ...
    outerDot: {
      border: '16px solid ' + theme.palette.main,
      borderWidth: 16,
      position: 'absolute',
      top: -16 + 1,
      right: -16,
    ...
    outerDotOdd: {
      background: (0, _colorManipulator.getContrastRatio)(theme.palette.main, theme.palette.common.fullBlack) < 7 ? theme.palette.common.fullWhite : theme.palette.common.fullBlack,
      width: 4,
      height: 4,
      borderWidth: 14
    }
